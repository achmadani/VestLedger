    ...
    public function menu(): array
    {
        return [
            ...
            [
                ...
                'icon'  => 'transaction',
                'items' => [
                    ['label' => 'Semua Transaksi', 'route' => '/transactions', 'permission' => 'transaction.view', 'enabled' => false, 'phase' => 'Phase 3'],
                    ['label' => 'Beli Saham', 'route' => '/transactions/buy', 'permission' => 'transaction.create', 'enabled' => false, 'phase' => 'Phase 3'],
                    ['label' => 'Jual Saham', 'route' => '/transactions/sell', 'permission' => 'transaction.create', 'enabled' => false, 'phase' => 'Phase 3'],
                    ['label' => 'Dividen', 'route' => '/transactions/dividend', 'permission' => 'transaction.create', 'enabled' => false, 'phase' => 'Phase 3'],
                    ['label' => 'Top Up Dana', 'route' => '/transactions/top-up', 'permission' => 'transaction.create', 'enabled' => false, 'phase' => 'Phase 3'],
                    ['label' => 'Withdrawal', 'route' => '/transactions/withdrawal', 'permission' => 'transaction.create', 'enabled' => false, 'phase' => 'Phase 3'],
                    ['label' => 'Transfer Antar Sekuritas', 'route' => '/transactions/transfer', 'permission' => 'transaction.create', 'enabled' => false, 'phase' => 'Phase 3'],
                    ['label' => 'Biaya Administrasi', 'route' => '/transactions/fee', 'permission' => 'transaction.create', 'enabled' => false, 'phase' => 'Phase 3'],
                ],
            ],
            [
                'label' => 'Akuntansi',
            ...
            [
                ...
                'icon'  => 'report',
                'items' => [
                    ['label' => 'Neraca', 'route' => '/reports/balance-sheet', 'permission' => 'report.view', 'enabled' => false, 'phase' => 'Phase 6'],
                    ['label' => 'Laba Rugi', 'route' => '/reports/income-statement', 'permission' => 'report.view', 'enabled' => false, 'phase' => 'Phase 6'],
                    ['label' => 'Arus Kas', 'route' => '/reports/cash-flow', 'permission' => 'report.view', 'enabled' => false, 'phase' => 'Phase 6'],
                    ['label' => 'Laporan Bulanan', 'route' => '/reports/monthly', 'permission' => 'report.view', 'enabled' => false, 'phase' => 'Phase 6'],
                    ['label' => 'Laporan Tahunan', 'route' => '/reports/yearly', 'permission' => 'report.view', 'enabled' => false, 'phase' => 'Phase 6'],
                    ['label' => 'Realized Gain/Loss', 'route' => '/reports/realized', 'permission' => 'report.view', 'enabled' => false, 'phase' => 'Phase 6'],
                    ['label' => 'Unrealized Gain/Loss', 'route' => '/reports/unrealized', 'permission' => 'report.view', 'enabled' => false, 'phase' => 'Phase 6'],
                    ['label' => 'Dividen', 'route' => '/reports/dividend', 'permission' => 'report.view', 'enabled' => false, 'phase' => 'Phase 6'],
                    ['label' => 'Broker Fee', 'route' => '/reports/broker-fee', 'permission' => 'report.view', 'enabled' => false, 'phase' => 'Phase 6'],
                ],
            ],
            [
                'label' => 'Master Data',
            ...
            [
                ...
                'icon'  => 'shield',
                'items' => [
                    ['label' => 'Audit Trail', 'route' => '/system/audit', 'permission' => 'audit.view', 'enabled' => false, 'phase' => 'Phase 4'],
